...
//     fn samples(&self) -> Samples<'_, SAMPLE, ENDIANNESS, STRIDE>;
//     fn samples_mut(&mut self) -> SamplesMut<'_, SAMPLE, ENDIANNESS, STRIDE>;
// }

// trait SampleAccess2<SAMPLE, READER: Iterator<Item = SAMPLE>, WRITER: SampleWriter<SAMPLE>, CELL: SampleCell<SAMPLE>> {
//     fn get_sample(&self, index: usize) -> SAMPLE;
//     fn set_sample(&mut self, index: usize, sample: SAMPLE);
//     //fn samples<I: Iterator<Item=SAMPLE>>(&self) -> I;
//     fn samples(&self) -> READER;
//     fn samples_mut(&mut self) -> WRITER;
// }

// trait SampleReader<SAMPLE>: Iterator<Item = SAMPLE> {
// }

// trait SampleWriter<SAMPLE, CELL: SampleCell<SAMPLE>>: Iterator<Item = CELL> {
// }

// impl<'a, SAMPLE, const ENDIANNESS: Endianness, const STRIDE: usize> RawSampleBuffer<'a, SAMPLE, ENDIANNESS, STRIDE> {
...
// pub struct Samples<'a, SAMPLE, const ENDIANNESS: Endianness, const STRIDE: usize> {
//     bytes: &'a [u8],
//     _phantom_data: PhantomData<SAMPLE>,
// }

// impl<'a, SAMPLE, const ENDIANNESS: Endianness, const STRIDE: usize> Samples<'a, SAMPLE, ENDIANNESS, STRIDE> {
...
// impl<SAMPLE, const ENDIANNESS: Endianness, const STRIDE: usize> Iterator for Samples<'_, SAMPLE, ENDIANNESS, STRIDE>
// where SAMPLE: FromBytes<STRIDE, ENDIANNESS>
// {
//     type Item = SAMPLE;
...
// struct SamplesMut<'a, SAMPLE, const ENDIANNESS: Endianness, const STRIDE: usize> {
//     bytes: &'a mut [u8],
//     _phantom_data: PhantomData<SAMPLE>,
// }

// impl<'a, SAMPLE, const ENDIANNESS: Endianness, const STRIDE: usize> SamplesMut<'a, SAMPLE, ENDIANNESS, STRIDE>
// where
...
// impl<'a, SAMPLE: Sample + FromToBytes<ENDIANNESS, STRIDE>, const ENDIANNESS: Endianness, const STRIDE: usize> Iterator for SamplesMut<'a, SAMPLE, ENDIANNESS, STRIDE> {
//     type Item = SampleMut<'a, SAMPLE, ENDIANNESS, STRIDE>;

//     fn next(&mut self) -> Option<SampleMut<'a, SAMPLE, ENDIANNESS, STRIDE>> {
//         if self.bytes.len() < STRIDE {
//             None
//         } else {
...
// pub trait SampleCell<SAMPLE> {
//     fn get(&self) -> SAMPLE;
//     fn set(&mut self, sample: SAMPLE);
// }

// pub struct SampleMut<'a, SAMPLE, const ENDIANNESS: Endianness, const STRIDE: usize> {
//     bytes: &'a mut [u8; STRIDE],
//     _phantom_data: PhantomData<SAMPLE>,
// }

// impl<'a, SAMPLE, const ENDIANNESS: Endianness, const STRIDE: usize> SampleMut<'a, SAMPLE, ENDIANNESS, STRIDE>
// where
//     SAMPLE: FromToBytes<ENDIANNESS, STRIDE>
// {
...
// impl<SAMPLE, const ENDIANNESS: Endianness, const STRIDE: usize> SampleAccess<SAMPLE, ENDIANNESS, STRIDE> for RawSampleBuffer<'_, SAMPLE, ENDIANNESS, STRIDE>
// where
//     SAMPLE: FromToBytes<ENDIANNESS, STRIDE>,
// {
//     #[inline]
