...
impl Head {
    ...
    #[expect(clippy::needless_pass_by_ref_mut, reason = "match mutability of the returned slice")]
...
impl<Marker: DirectionMarker> Simplex<Marker> {
    pub fn new(format: SampleFormat, frame_count: FrameCount, buf_ptrs: Vec<DoubleBuffer>, latency: Duration) -> Self {
        ...
        Self { head, scratch, latency, _marker: Marker::default() }
    }
