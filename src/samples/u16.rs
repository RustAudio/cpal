...
impl ToBytes<BYTES, LITTLE_ENDIAN> for u16 {
    #[inline]
    fn to_bytes(self) -> [u8; BYTES] {
        self.to_le_bytes()
    }
}
impl ToBytes<BYTES, BIG_ENDIAN> for u16 {
    #[inline]
    fn to_bytes(self) -> [u8; BYTES] {
        self.to_be_bytes()
    }
}
impl FromBytes<BYTES, LITTLE_ENDIAN> for u16 {
    #[inline]
    fn from_bytes(bytes: [u8; BYTES]) -> Self {
        Self::from_le_bytes(bytes)
    }
}
impl FromBytes<BYTES, BIG_ENDIAN> for u16 {
    #[inline]
    fn from_bytes(bytes: [u8; BYTES]) -> Self {
