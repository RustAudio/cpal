...
pub struct B2LE {}
transcoder!(B2LE, Sample, BYTES, LITTLE_ENDIAN, SampleFormat::I16B2(Endianness::Little));

pub struct B2BE {}
transcoder!(B2BE, Sample, BYTES, BIG_ENDIAN, SampleFormat::I16B2(Endianness::Big));
